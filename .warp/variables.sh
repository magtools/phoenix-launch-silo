...
# DOCKERCOMPOSEFILE contains the path
# to the development docker-compose file generated by Warp
DOCKERCOMPOSEFILEDEV="$PROJECTPATH/docker-compose-warp.yml.dev"

# DOCKERCOMPOSEFILE contains the path
# to the production docker-compose file generated by Warp
DOCKERCOMPOSEFILEPROD="$PROJECTPATH/docker-compose-warp.yml.prod"
